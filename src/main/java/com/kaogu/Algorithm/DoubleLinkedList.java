...
//                angle2 = Math.acos(angle2);
                ...
                double h11 = dot11.getH();
                double h12 = dot12.getH();
                double h21 = dot21.getH();
                double h22 = dot22.getH();
                double maxk1 = Math.max(Math.abs(k11), Math.abs(k21));
                double maxk2 = Math.max(Math.abs(k12), Math.abs(k22));
                double maxh1 = Math.max(Math.abs(h11), Math.abs(h21));
                double maxh2 = Math.max(Math.abs(h12), Math.abs(h22));
                double resk1 = k11 - k21;
                double resk2 = k12 - k22;
                double resh1 = h11 + h21;
                double resh2 = h12 + h22;
                if (Math.abs(resk1) < 0.5 * maxk1 && Math.abs(resk2) < 0.5 * maxk2) {
                    if (i == 0 || j == 0) {
